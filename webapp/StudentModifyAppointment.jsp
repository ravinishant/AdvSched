                    ...
                    <div id="appointmentAccordion" class="centerthis">
                            ...
                            <div>
                                ...
                                <%
                                    ...
                                    java.util.ArrayList<uta.cse4361.businessobjects.StudentAppointment> appts = dm.getStudentAppointments(s); 
                                    for(StudentAppointment a: appts) {
                                        ...
                                        out.print("</td>");
                                        out.print("<td>");
                                        out.print("<input type='radio' name='apptID'checked='true' value='" +a.getApptID()+"'>");
                                        out.print("</td>");
                                        out.print("</tr>");
                                        out.print("</script>");
                                    }
