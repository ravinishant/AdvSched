...
public class ScheduleAppointmentBean implements Constants {
    ...
    public String scheduleAppointment() {
        ...
        String studentemail = this.studentEmail;
        ...
        EventSync sync1 = new EventSync(studentemail, startTime, endTime);
        try{
            sync1.send("New Student Appointment",generateStudentMessage(), "New Advising Appointment");
        } catch (Exception e){
            e.printStackTrace();
        }
        return msg;
