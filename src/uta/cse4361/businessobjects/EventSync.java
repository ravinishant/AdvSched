...
public class EventSync {
    ...
    String fromEmail = "mavnotification2017@gmail.com";
    String toEmail;
    Calendar start;
    Calendar end;
    ...
    public void send(String subject, String description, String summary) throws Exception {
      ...
      final String username = "mavnotification2017@gmail.com";//change accordingly
      final String password = "mavnotification2018";//change accordingly
      ...
      new javax.mail.Authenticator() {
        ...
        try {
            ...
            StringBuffer buffer = sb.append("BEGIN:VCALENDAR\n" +
                    ...
                    "METHOD:REQUEST\n" +
                    "BEGIN:VEVENT\n" +
                    "ATTENDEE;ROLE=REQ-PARTICIPANT;RSVP=TRUE:MAILTO:mavnotification2017@gmail.com\n" +
                    "ORGANIZER:MAILTO:mavnotification2017@gmail.com\n" +
